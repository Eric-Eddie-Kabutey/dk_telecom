...
const statsData = [
  { id: 1, icon: Smartphone, label: "Connected Device", value: "50M+", description: "Trusted worldwide" },
  { id: 2, icon: Signal, label: "Network Uptime", value: "99.9%", description: "Guaranteed reliability" },
  { id: 3, icon: Gauge, label: "Max Speed", value: "10Gbps", description: "Wide Range Reach" },
  { id: 4, icon: Globe, label: "Cities Covered", value: "500+", description: "Industry Expertise" },
];
            ...
            <div key={stat.id} className="rounded-2xl p-[1px] bg-gradient-to-br from-yellow-400/40 via-indigo-500/0 to-indigo-500/40">
              <div className="rounded-[15px] bg-indigo-950/70 backdrop-blur-md h-full w-full 2xl:w-[300px] p-6 2xl:px-2 md:text-start flex flex-col">
                ...
                <div className="my-auto flex items-center justify-center lg:justify-start gap-2 text-yellow-300">
                  ...
                  <AnimatedNumber value={stat.value} className="text-6xl font-bold tracking-tighter" />
                </div>
