...
import { consulting_services } from '@/constants/services';
        ...
        <section className='max-container 2xl:w-[85%] md:w-[95%] w-[90%] mx-auto flex flex-col gap-8'>
            <div className='max-w-[650px] flex flex-col gap-3'>
                ...
                <Typography
                    ...
                    className='text-gray-500'
                >
                    Transform your operations, unlock efficiency, and achieve measurable outcomes with our bespoke consulting 
                    solutions.
                </Typography>
            </div>
            <div className='w-full py-8 overflow-auto'>
                <div className='w-fit px-3 flex gap-8 flex-nowrap'>
                    {consulting_services.map((data, index) => (
                        <Card
                            key={data.id}
