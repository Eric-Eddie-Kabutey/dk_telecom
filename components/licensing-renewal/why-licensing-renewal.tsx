...
import consultingImg from "@/public/assets/images/services/why_licensing_img.png"
import Image from 'next/image';
import { licensing_reasons } from '@/constants/services';

function WhyLicensingRenewalServices() {
  return (
            ...
            <div className='w-full flex lg:flex-row flex-col justify-between xl:gap-32 gap-16'>
                ...
                <div className='flex-1 '>
                    <div className='w-full flex flex-col gap-5'>
                        {licensing_reasons.map((data, index) => (
...
export default WhyLicensingRenewalServices