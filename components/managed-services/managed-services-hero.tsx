...
function ManagedServicesHero() {
  return (
    <div className='w-full pt-4'>
        <section className='container mx-auto w-[95%] max-h-[700px] h-[85vh] relative'>
            ...
            <div className='pops absolute bottom-16 inset-x-0 container mx-auto 2xl:w-[85%] w-[95%] flex flex-col gap-6 text-white z-20'>
