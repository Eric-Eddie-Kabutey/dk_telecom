...
import hero_1 from "@/public/assets/images/services/bpo-banner.png";
import Image from 'next/image';
import Typography from '../shared/typography';
import { Button } from '../ui/button';
import { ArrowRight } from 'lucide-react';

function LicensingRenewalHero() {
  return (
        ...
        <section className='w-[95%] max-h-[700px] h-[85vh] relative mx-auto'>
            ...
            <div className='pops absolute bottom-16 inset-x-0 max-container 2xl:w-[85%] w-[95%] flex flex-col gap-6 text-white z-20'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    >
                        Simplifying Licence Management for Maximum
                    </Typography>
                    <Typography
                        typo="body-medium-regular"
                        className='!font-light text-gray-300'
...
export default LicensingRenewalHero