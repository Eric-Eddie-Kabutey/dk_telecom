    ...
    <div className="max-w-3xl mx-auto flex items-center">
      ...
      <div className="flex-shrink-0 flex items-center gap-2 border border-blue-400/30 bg-white/10 px-4 py-2 md:py-4 rounded-lg backdrop-blur-sm">
        <Zap className="h-4 w-4 text-yellow-300" />            
            <p className="text-lg lg:text-2xl font-semibold uppercase tracking-wider text-white">{text}</p>
      </div>
      <div className="flex-grow h-px bg-[#3423c6]"></div>
    </div>
);
...
export function NextGeneration() {
  ...
  return (
    <section 
      ref={targetRef} 
      className="relative lg:h-[400vh] bg-[#130B54] text-white px-4"
    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-center md:mt-8">
                ...
                <div className="relative">              
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 mt-12">
                        <Button size="lg" className="bg-[#F8D653] text-black hover:bg-[#F8D633] rounded-lg w-full sm:w-auto">
                            Get Connected Today <ArrowUpRight className="ml-2 h-5 w-5" />
                        </Button>
                        <Button size="lg" variant="outline" className="bg-transparent border-blue-400/50 hover:bg-blue-400/10 text-[#F8D653] hover:text=[#F8D633] rounded-lg w-full sm:w-auto">
                            Download Brochure
                        </Button>
                    </div>
                </div>
